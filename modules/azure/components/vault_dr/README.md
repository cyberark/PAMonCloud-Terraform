...
```hcl
module "vault_dr_vm" {
    source       = "../../../modules/azure/components/vault_dr"
...
- [single-region_complete-pam](https://github.com/cyberark/PAMonCloud-terraform/tree/master/examples/azure/single-region_complete-pam) with Vault DR.
